...
public class KftcServiceImpl implements KftcService {
    ...
    @Override
    public KftcServiceImpl requestToken() {
        ...
        this.token =  getValue(returnData,"access_token");
        System.out.println("token 저장 완료" + this.token);
    ...
    @Override
    public void realName(RealName realName) throws Exception {
