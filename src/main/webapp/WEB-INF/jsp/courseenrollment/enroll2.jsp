...
<body class='site-menubar-unfold' data-action='edit'
	...
	<div class='col-md-9'>
		...
		<form data-validation="false" data-istour="true" data-isticket="false"
			data-ishotdeal="false" data-islodging="false"
			data-offer-status="temp" id="offerForm" class="panel panel-bordered"
			action="/partner/offers/46144" accept-charset="UTF-8" method="post">
			<input name="utf8" type="hidden" value="&#x2713;" /> <input
				type="hidden" name="_method" value="put" /> <input type="hidden"
				name="authenticity_token"
				value="SieLJssO/fGdnzpGz7cdGbvXQeZJQmeoPiYGz+aTpq1QrEH4RGZjLEdppyPlVrz1idqG5Wv9u6staoFGkks08A==" />
			...
			<div class='panel-body' style="background-color: saddlebrown;">
						...
						<div class='col-xs-12'>
							<ul class='margin-top-20 sortable-list clearfix'
								...
								<li class='col-xs-12 course-item ui-state-default'>
									<div id="coursedetail"
										class='widget widget-shadow widget-border'>
											...
											<div class='row'>
												<div class='col-xs-12'>
													<div class='form-group clearfix'
														...
														<div class='col-xs-12'>
															<input class='form-control offerCourseTitle'
											...
											<div class='row'>
												<div class='col-xs-12'>
													<div class='form-group clearfix'
														...
														<div class='col-xs-12'>
															<textarea class='form-control offerCourseIntro'
				...
				<div class='wizard-buttons'>
					<a class='btn btn-default btn-outline'
						href='/partner/offers/46144/edit?step=1' role='button'>이전 단계로</a>
					<input class='btn btn-primary btn-outline pull-right' id='save'
