				...
				<div class="bg-1">
					<div class="container text-center">
						<form id="uploadForm" method="post" enctype="multipart/form-data">
							<input id='imgBtn' type="file" name='file1' multiple
								accept="image/*" style="display: none">
						</form>
						<form>


							<img src="/resources/img/${sessionScope.memberInfo.photo}"
								id="userImage" class="img-circle" alt="userImage" width="150"
								height="150" onclick='document.all.file1.click();'>
								...
								<c:when test="${sessionScope.memberInfo.path eq 'google'}">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="name" class="form-control" id="name"
												value='${sessionScope.memberInfo.name }' readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="email" class="form-control" id="email"
												value='${sessionScope.memberInfo.email}' readonly="readonly">
										</div>
									</div>


									<div class="form-group">
										<label class="control-label col-sm-3" for="email">SNS
											연동:</label>
										<div class="col-sm-8">
											<label class="control-label col-sm-3" for="email">Facebook</label>
											<label class="switch col-sm-3"> <input
												type="checkbox" disabled='true'> <span
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<label class="switch col-sm-3"> <input
												type="checkbox" disabled='true' checked> <span
												class="slider round"></span>
											</label>
										</div>
									</div>
									...
									<c:choose>
										<c:when test="${sessionScope.memberInfo.cert_email eq 'N'}">
											<div class="form-group has-error">
												<label class="control-label col-sm-3" for="email">이메일:</label>
												<div class="col-sm-8">
													<input type="email" class="form-control emailAuthUse"
														id="email" value='${sessionScope.memberInfo.email }'
														style="width: 80%">
													<button type="button" class="btn btn-info emailAuthUse">이메일
														연동하기</button>
												</div>
											</div>
										</c:when>
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="sel1">선호하는
									언어:</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<div class="col-sm-11">
									<button id='modifyBtn' type="button" class="btn btn-info"
										style="float: right; margin-top: 30px;">저장하기</button>
									<button id='PhotoModifyBtn' type="button" class="btn btn-info"
										style="float: right; margin-top: 30px;">사진</button>
								</div>
