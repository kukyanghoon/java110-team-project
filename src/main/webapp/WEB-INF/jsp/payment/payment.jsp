...
<span class="pull-right">2018-11-15</span>
<input name="choice_set[begin_at]" type="hidden" value="2018-11-15" data-fv-field="choice_set[begin_at]">
</div>
<div class="item">
<span><spring:message code="rsv.parti" text="여행 인원" /></span>

<span class="pull-right long-text">홍길동 포함 3 명</span>
<input name="choice_set[choices][][travelers]" readonly="" type="hidden" value="3" data-fv-field="choice_set[choices][][travelers]">
<input name="choice_set[choices][][key]" readonly="" type="hidden" value="28313">
</div>
</div>
...
<div class="pull-right price-container" data-amount="54000" data-currency="KRW" data-price="₩ 54,000">54,000원</div>
</div>
</div>
...
<input name="reservation_uuid" type="hidden" value="fd7125e7-80bb-47d0-86de-634f29f70139">
...
<img id="ci-img" src="/resources/img/paypal.png" alt="Paypal CI" style="width:78px; 	height: 25px;">
</label>
...
<div class="clearfix">
<div class="radio-custom radio-primary">
<input id="type-bank" name="payment[paytype]" type="radio" value="bank" data-fv-field="payment[paytype]" autocomplete="off">
<label for="type-bank"><spring:message code="rsv.transfer" text="실시간계좌이체" /></label>
